...
figure
sgtitle("Overlapping Truncation Windows to Increase Temporal Resolution");
subplot(1, 3, 1);
spectrogramPSD(signal, fs, window, freq*3, -40, 0, yScale='lin');
subplot(1, 3, 2);
spectrogramPSD(signal, fs, window, freq*3, -40, 0.5, yScale='lin');
subplot(1, 3, 3);
spectrogramPSD(signal, fs, smallerWindow, freq*3, -40, 0, yScale='lin');
